...
public class Frame645_New {
	...
	// 构造函数，根据645报文，得到对象
	public Frame645_New(String frame) {
		String coll_param = "", suffix = "";
...
//			Data = DataConvert.HexStrReduce33H(Data);
	...
	public Frame645_New(String addr, String control, String data) {
		Addr = addr;
		Control = control;
		Data = data;
		Data_item = "";
	...
	public String get645FrameNoCS() {
		...
		if (aColl.equals(""))
			aData = formatData_New(Data);  // // xuky 2018.07.27 无需进行处理
		else {
	...
	public static String formatData_New(String str) {
//		String sTemp = "";
//		String aStr = "";
//		int num = str.length() / 2;
//		int temp = 0;
...
//		// 129.1.22.11
//		frame645.setAddr("0B1601810000");
//		frame645.setControl("14");
//		frame645.setData("04 96 96 01 010203040506 201807271118".replaceAll(" ", ""));
//		System.out.println(frame645.get645Frame());
////		6800008101160B681410049696010102030405062018072711186C16

//		// 回复数据
//		frame645 = new Frame645_New();
//		frame645.setAddr("0B1601810000");
//		frame645.setControl("94");
//		frame645.setData("84 96 96 01 01 0101 0201 0301 0401".replaceAll(" ", ""));
//		System.out.println(frame645.get645Frame());
////		6800008191160B68940D849696010101010201030104016416
//
//		String str = "6800008101160B681410049696010102030405062018072711186C16";
//		frame645 = new Frame645_New(str,"","");
//		System.out.println(frame645.getData());

		String str = "6800008101160F68940D84969601010101020103010401D816";
		Frame645_New frame645 = new Frame645_New(str,"","");
		System.out.println(frame645.getData());
