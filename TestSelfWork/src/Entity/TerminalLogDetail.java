...
@Entity
@Table(name="terminallogdetail")
public class TerminalLogDetail {
    int ID;
...
//    	result = "";
	...
	public String getSendtime0() {
		return sendtime0;
	}

	public void setSendtime0(String sendtime0) {
		this.sendtime0 = sendtime0;
	}
